...
export function AboutPreview() {
  ...
  return <section className="section about-preview"><div className="container about-grid"><div className="about-image-wrap">{profileImage ? <Image src={profileImage} alt="Evol Visuals portrait" fill sizes="(max-width: 768px) 100vw, 46vw" /> : null}<span className="image-note">Evol Visuals</span></div><div className="about-copy"><p className="kicker">03 / Behind the timeline</p><h2>Good editing is something you feel before you notice.</h2><p>I&apos;m {siteConfig.editorName},  video editor focused on clear storytelling, emotional pacing, and thoughtful craft. This introduction is ready for your own voice, background, and perspective.</p><p>My job is to find the strongest version of the story already hiding in the footage—and make every second earn its place.</p><Link className="text-link" href="/about">More about my approach <ArrowUpRight /></Link></div></div></section>;
}
